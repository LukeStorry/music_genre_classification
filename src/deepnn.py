...
def graph_with_batch_normalisation(x, is_training):
    ...
    left_conv_bn_1 = leaky_relu(tf.layers.batch_normalization(left_conv_1,
                                                              beta_initializer=xavier_initializer,
                                                              gamma_initializer=xavier_initializer,
                                                              training=is_training))

    left_pooling_1 = tf.layers.max_pooling2d(
        inputs=left_conv_bn_1,
        pool_size=[2, 2],
        strides=[2, 2],
        name='left_pooling'
    )
    ...
    left_conv_bn_2 = leaky_relu(tf.layers.batch_normalization(left_conv_2,
                                                              beta_initializer=xavier_initializer,
                                                              gamma_initializer=xavier_initializer,
                                                              training=is_training))

    left_pooling_2 = tf.layers.max_pooling2d(
        inputs=left_conv_bn_2,
        pool_size=[2, 2],
        strides=[2, 2],
        name='left_pooling_2'
    )
    ...
    left_conv_bn_3 = leaky_relu(tf.layers.batch_normalization(left_conv_3,
                                                              beta_initializer=xavier_initializer,
                                                              gamma_initializer=xavier_initializer,
                                                              training=is_training))

    left_pooling_3 = tf.layers.max_pooling2d(
        inputs=left_conv_bn_3,
        pool_size=[2, 2],
        strides=[2, 2],
        name='left_pooling_3'
    )
    ...
    left_conv_bn_4 = leaky_relu(tf.layers.batch_normalization(left_conv_4,
                                                              beta_initializer=xavier_initializer,
                                                              gamma_initializer=xavier_initializer,
                                                              training=is_training))
    ...
    right_conv_bn_1 = leaky_relu(tf.layers.batch_normalization(right_conv_1,
                                                               beta_initializer=xavier_initializer,
                                                               gamma_initializer=xavier_initializer,
                                                               training=is_training))

    right_pooling_1 = tf.layers.max_pooling2d(
        inputs=right_conv_bn_1,
        pool_size=[2, 2],
        strides=[2, 2],
        name='right_pooling'
    )
    ...
    right_conv_bn_2 = leaky_relu(tf.layers.batch_normalization(right_conv_2,
                                                               beta_initializer=xavier_initializer,
                                                               gamma_initializer=xavier_initializer,
                                                               training=is_training))

    right_pooling_2 = tf.layers.max_pooling2d(
        inputs=right_conv_bn_2,
        pool_size=[2, 2],
        strides=[2, 2],
        name='right_pooling_2'
    )
    ...
    right_conv_bn_3 = leaky_relu(tf.layers.batch_normalization(right_conv_3,
                                                               beta_initializer=xavier_initializer,
                                                               gamma_initializer=xavier_initializer,
                                                               training=is_training))

    right_pooling_3 = tf.layers.max_pooling2d(
        inputs=right_conv_bn_3,
        pool_size=[2, 2],
        strides=[2, 2],
        name='right_pooling_3'
    )
    ...
    right_conv_bn_4 = leaky_relu(tf.layers.batch_normalization(right_conv_4,
                                                               beta_initializer=xavier_initializer,
                                                               gamma_initializer=xavier_initializer,
                                                               training=is_training))
